 ...
 * Desc: Heightmap template definitions (ported from original Azgaar)
 * Author: Lordthoth (based on original by Azgaar)
 * =============================================================================
 */

/**
 * All 14 heightmap templates (exact match to original Azgaar format)
 * Each template includes id, name, template string, and probability
 * Keys match original capitalization: 'Volcano', 'High Island', etc.
 */
...
/**
 * Get template by name (case-insensitive, supports both formats)
 * @param {string} name - Template name (e.g., "Volcano", "volcano", "Continents", "continent")
 * @returns {Object|null} Template object with {id, name, template, probability} or null if not found
 */
export function getTemplate(name) {
  ...
  // Try lowercase key match (backward compatibility)
 ...
 * @returns {string[]} Array of template names (capitalized keys)
 */
