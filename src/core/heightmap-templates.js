...
/**
 * All 14 heightmap templates
 * Each template is a string with operations separated by newlines
 * Format: "Operation count height rangeX rangeY"
 */
export const heightmapTemplates = {
  ...
  continent: `Hill 1 80-85 60-80 40-60
...
export function getTemplate(name) {
  ...
  return heightmapTemplates[key] || null;
}
